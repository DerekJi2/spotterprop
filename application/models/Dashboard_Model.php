...
class Dashboard_Model extends CI_Model
{
    ...
    **/
    ...
    public function before_session_starts()
    {
        ...
        $this->config->set_item('tendoo_logo_min', '<img id="tendoo-logo" style="height:30px;" src="' . img_url() . 'syprop.ico' . '" alt=logo>');

        $this->config->set_item('syprop_logo_long', 'Syrian<b>Properties</b>');
    }

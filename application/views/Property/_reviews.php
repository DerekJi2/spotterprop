...
<section class="block" id="reviews">
    <header class="clearfix">
        ...
        <a href="<?php echo site_url('#write-review') ?>" class="btn framed icon pull-right roll">Write a review <i class="fa fa-pencil"></i></a>
    </header>
    ...
    <section class="reviews">
        <article class="review">
            <figure class="author">
                <img src="<?php echo site_url('assets/img/default-avatar.png') ?>" alt="">

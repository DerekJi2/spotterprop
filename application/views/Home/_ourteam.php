    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-3 col-sm-3">
                <div class="member">
                    <img src="<?php echo site_url('assets/img/member-1.jpg') ?>" alt="">
                    <h4>Jane Daubert</h4>
            ...
            <div class="col-md-3 col-sm-3">
                <div class="member">
                    <img src="<?php echo site_url('assets/img/member-2.jpg') ?>" alt="">
                    <h4>Kristy Jose</h4>
            ...
            <div class="col-md-3 col-sm-3">
                <div class="member">
                    <img src="<?php echo site_url('assets/img/member-4.jpg') ?>" alt="">
                    <h4>Misty Bates</h4>

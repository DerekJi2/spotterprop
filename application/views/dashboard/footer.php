...
<?php echo $this->events->apply_filters('dashboard_footer_text', '<small>' . sprintf(__('Thank you for using Syrian Properties &mdash; %s in %s seconds'), $this->benchmark->memory_usage(), '{elapsed_time}') . '</small>');?>
</footer>
